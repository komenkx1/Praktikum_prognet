...
class PaymentController extends Controller
{
	 ...
	 */
	        ...
	        public function initPaymentGateaway(){
...
\Midtrans\Config::$is3ds = true;
	...
	public function notification(Request $request)
	{
		...
		$order = Transactions::where('code', $paymentNotification->order_id)->firstOrFail();
	...
	public function completed(Request $request)
	{
		...
		$order = Transactions::where('code', $code)->firstOrFail();
		...
		return redirect(Route('detail-transaksi', ['transactions' => encrypt($order->id)]));
	}
